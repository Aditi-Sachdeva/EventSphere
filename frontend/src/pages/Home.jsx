...
const Home = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen text-gray-800">
      ...
      {/* Event Section */}
      <section id="events-section" className="py-16 pb-8 bg-gradient-to-b from-gray-50 via-pink-50/30 to-indigo-50/30">
      ...
      {/* Club Section */}
      <section id="clubs-section" className="py-16 bg-gradient-to-b from-indigo-50/30 via-pink-50/30 to-gray-100">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex justify-between items-center mb-10">
